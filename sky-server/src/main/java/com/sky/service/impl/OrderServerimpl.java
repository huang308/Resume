...
public class OrderServerimpl implements OrderService {
    ...
    public PageResult pageQuery4User(int page, int pageSize, Integer status) {
        ...
        return new PageResult(p.getTotal(), listVO);
    }
    ...
    @Override
    public OrderStatisticsVO orderStageStatistics() {

        Integer toBeConfirmed = orderMapper.orderStageStatistics(Orders.TO_BE_CONFIRMED); // SQL 1
        Integer confirmed = orderMapper.orderStageStatistics(Orders.CONFIRMED);           // SQL 2
        Integer deliveryInProgress = orderMapper.orderStageStatistics(Orders.DELIVERY_IN_PROGRESS); // SQL 3
